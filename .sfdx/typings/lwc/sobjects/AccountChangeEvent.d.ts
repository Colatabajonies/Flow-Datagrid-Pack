...
declare module "@salesforce/schema/AccountChangeEvent.FDGPack__CustomerPriority__c" {
  const FDGPack__CustomerPriority__c:string;
  export default FDGPack__CustomerPriority__c;
}
declare module "@salesforce/schema/AccountChangeEvent.FDGPack__SLA__c" {
  const FDGPack__SLA__c:string;
  export default FDGPack__SLA__c;
}
declare module "@salesforce/schema/AccountChangeEvent.FDGPack__Active__c" {
  const FDGPack__Active__c:string;
  export default FDGPack__Active__c;
}
declare module "@salesforce/schema/AccountChangeEvent.FDGPack__NumberofLocations__c" {
  const FDGPack__NumberofLocations__c:number;
  export default FDGPack__NumberofLocations__c;
}
declare module "@salesforce/schema/AccountChangeEvent.FDGPack__UpsellOpportunity__c" {
  const FDGPack__UpsellOpportunity__c:string;
  export default FDGPack__UpsellOpportunity__c;
}
declare module "@salesforce/schema/AccountChangeEvent.FDGPack__SLASerialNumber__c" {
  const FDGPack__SLASerialNumber__c:string;
  export default FDGPack__SLASerialNumber__c;
}
declare module "@salesforce/schema/AccountChangeEvent.FDGPack__SLAExpirationDate__c" {
  const FDGPack__SLAExpirationDate__c:any;
  export default FDGPack__SLAExpirationDate__c;
}
declare module "@salesforce/schema/AccountChangeEvent.FDGPack__Latitude__c" {
  const FDGPack__Latitude__c:number;
  export default FDGPack__Latitude__c;
}
declare module "@salesforce/schema/AccountChangeEvent.FDGPack__Longitude__c" {
  const FDGPack__Longitude__c:number;
  export default FDGPack__Longitude__c;
}
