...
declare module "@salesforce/schema/Lead.FDGPack__SICCode__c" {
  const FDGPack__SICCode__c:string;
  export default FDGPack__SICCode__c;
}
declare module "@salesforce/schema/Lead.FDGPack__ProductInterest__c" {
  const FDGPack__ProductInterest__c:string;
  export default FDGPack__ProductInterest__c;
}
declare module "@salesforce/schema/Lead.FDGPack__Primary__c" {
  const FDGPack__Primary__c:string;
  export default FDGPack__Primary__c;
}
declare module "@salesforce/schema/Lead.FDGPack__CurrentGenerators__c" {
  const FDGPack__CurrentGenerators__c:string;
  export default FDGPack__CurrentGenerators__c;
}
declare module "@salesforce/schema/Lead.FDGPack__NumberofLocations__c" {
