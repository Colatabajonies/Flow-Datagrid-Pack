...
declare module "@salesforce/schema/ContactChangeEvent.FDGPack__Level__c" {
  const FDGPack__Level__c:string;
  export default FDGPack__Level__c;
}
declare module "@salesforce/schema/ContactChangeEvent.FDGPack__Languages__c" {
  const FDGPack__Languages__c:string;
  export default FDGPack__Languages__c;
}
