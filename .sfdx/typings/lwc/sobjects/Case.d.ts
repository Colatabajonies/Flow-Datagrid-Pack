...
declare module "@salesforce/schema/Case.FDGPack__EngineeringReqNumber__c" {
  const FDGPack__EngineeringReqNumber__c:string;
  export default FDGPack__EngineeringReqNumber__c;
}
declare module "@salesforce/schema/Case.FDGPack__SLAViolation__c" {
  const FDGPack__SLAViolation__c:string;
  export default FDGPack__SLAViolation__c;
}
declare module "@salesforce/schema/Case.FDGPack__Product__c" {
  const FDGPack__Product__c:string;
  export default FDGPack__Product__c;
}
declare module "@salesforce/schema/Case.FDGPack__PotentialLiability__c" {
