...
declare module "@salesforce/schema/OpportunityChangeEvent.FDGPack__DeliveryInstallationStatus__c" {
  const FDGPack__DeliveryInstallationStatus__c:string;
  export default FDGPack__DeliveryInstallationStatus__c;
}
declare module "@salesforce/schema/OpportunityChangeEvent.FDGPack__TrackingNumber__c" {
  const FDGPack__TrackingNumber__c:string;
  export default FDGPack__TrackingNumber__c;
}
declare module "@salesforce/schema/OpportunityChangeEvent.FDGPack__OrderNumber__c" {
  const FDGPack__OrderNumber__c:string;
  export default FDGPack__OrderNumber__c;
}
declare module "@salesforce/schema/OpportunityChangeEvent.FDGPack__CurrentGenerators__c" {
  const FDGPack__CurrentGenerators__c:string;
  export default FDGPack__CurrentGenerators__c;
}
declare module "@salesforce/schema/OpportunityChangeEvent.FDGPack__MainCompetitors__c" {
  const FDGPack__MainCompetitors__c:string;
  export default FDGPack__MainCompetitors__c;
}
